...
from wv_vww_cross_validate import cross_val
...
wv_small_config.SAVE_FILE = (
    wv_small_config.SAVE_DIR + f"{wv_small_config.MODEL_NAME}.keras"
)
...
vww_small_config.SAVE_FILE = (
    vww_small_config.SAVE_DIR + f"{vww_small_config.MODEL_NAME}.keras"
)
...
vww_large_config.SAVE_FILE = (
    vww_large_config.SAVE_DIR + f"{vww_large_config.MODEL_NAME}.keras"
)
...
wv_large_config.SAVE_FILE = (
    wv_large_config.SAVE_DIR + f"{wv_large_config.MODEL_NAME}.keras"
)
