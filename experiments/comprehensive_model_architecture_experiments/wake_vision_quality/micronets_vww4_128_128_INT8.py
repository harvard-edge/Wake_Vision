...
model_name = 'wv_quality_micronets_vww4_128_128_INT8'
...
#CONV 3,3,12
x = keras.layers.Conv2D(8, (3,3), padding='same', strides=(2,2))(inputs)
...
#IBN 14, 16
x = keras.layers.Conv2D(14, (1,1), padding='same')(y)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.DepthwiseConv2D((3,3), padding='same')(x)
x = keras.layers.BatchNormalization()(x)
...
x = keras.layers.BatchNormalization()(x)
#padding and add
y = keras.layers.ZeroPadding2D(padding=(0, 2), data_format="channels_first")(y)
...
y = keras.layers.BatchNormalization()(x)
#IBN 268, 40
x = keras.layers.Conv2D(268, (1,1), padding='same')(y)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.DepthwiseConv2D((3,3), padding='same')(x)
x = keras.layers.BatchNormalization()(x)
...
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.Conv2D(52, (1,1), padding='same')(x)
x = keras.layers.BatchNormalization()(x)
#padding and add
...
x = keras.layers.BatchNormalization()(x)
#padding and add
x = keras.layers.ZeroPadding2D(padding=(0, 4), data_format="channels_first")(x)
x = keras.layers.Add()([x, y])
#IBN 192, 68
x = keras.layers.Conv2D(192, (1,1), padding='same')(x)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.DepthwiseConv2D((3,3), padding='same')(x)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.Conv2D(68, (1,1), padding='same')(x)
y = keras.layers.BatchNormalization()(x)
#IBN 172, 68
x = keras.layers.Conv2D(172, (1,1), padding='same')(y)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.DepthwiseConv2D((3,3), padding='same')(x)
x = keras.layers.BatchNormalization()(x)
...
x = keras.layers.BatchNormalization()(x)
#padding and add
x = keras.layers.ZeroPadding2D(padding=(0, 10), data_format="channels_first")(x)
x = keras.layers.Add()([x, y])
#IBN 288, 16
x = keras.layers.Conv2D(288, (1,1), padding='same')(x)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.DepthwiseConv2D((3,3), padding='same', strides=(2,2))(x)
x = keras.layers.BatchNormalization()(x)
...
x = keras.layers.BatchNormalization()(x)
#padding and add
y = keras.layers.ZeroPadding2D(padding=(0, 8), data_format="channels_first")(y)
x = keras.layers.Add()([x, y])
#IBN 96, 32
