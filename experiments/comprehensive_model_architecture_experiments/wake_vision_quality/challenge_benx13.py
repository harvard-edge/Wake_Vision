...
x = keras.layers.Conv2D(12, (3,3), padding='valid', strides=(2,2))(x)
...
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.Conv2D(12, (1,1), padding='valid', strides=(1,1))(x)
x = keras.layers.Conv2D(36, (1,1), padding='valid', strides=(1,1))(x)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.ZeroPadding2D(padding=(1, 1))(x)
...
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
y = keras.layers.Conv2D(16, (1,1), padding='valid', strides=(1,1))(x)
#
x = keras.layers.Conv2D(48, (1,1), padding='valid', strides=(1,1))(y)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.ZeroPadding2D(padding=(1, 1))(x)
x = keras.layers.DepthwiseConv2D((3,3),  padding='valid')(x)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.Conv2D(16, (1,1), padding='valid', strides=(1,1))(x)
# add
x = keras.layers.Add()([x, y])
#
x = keras.layers.Conv2D(48, (1,1), padding='valid', strides=(1,1))(x)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
...
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
y = keras.layers.Conv2D(24, (1,1), padding='valid', strides=(1,1))(x)
#
x = keras.layers.Conv2D(96, (1,1), padding='valid', strides=(1,1))(y)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.ZeroPadding2D(padding=(1, 1))(x)
x = keras.layers.DepthwiseConv2D((3,3),  padding='valid')(x)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.Conv2D(24, (1,1), padding='valid', strides=(1,1))(x)
# add
x = keras.layers.Add()([x, y])
#
x = keras.layers.Conv2D(96, (1,1), padding='valid', strides=(1,1))(x)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.ZeroPadding2D(padding=(2, 2))(x)
x = keras.layers.DepthwiseConv2D((5,5),  padding='valid', strides=(2,2))(x)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
y = keras.layers.Conv2D(32, (1,1), padding='valid', strides=(1,1))(x)
#
x = keras.layers.Conv2D(96, (1,1), padding='valid', strides=(1,1))(y)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
...
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.Conv2D(32, (1,1), padding='valid', strides=(1,1))(x)
# add
x = keras.layers.Add()([x, y])
x = keras.layers.Conv2D(128, (1,1), padding='valid', strides=(1,1))(x)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.ZeroPadding2D(padding=(1, 1))(x)
x = keras.layers.DepthwiseConv2D((3,3),  padding='valid')(x)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.ReLU(max_value=6.0)(x)
x = keras.layers.Conv2D(40, (1,1), padding='valid', strides=(1,1))(x)
#
